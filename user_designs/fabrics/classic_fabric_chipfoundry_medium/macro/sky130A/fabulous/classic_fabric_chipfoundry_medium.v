module classic_fabric_chipfoundry_medium
    ...
    (
        ...
        input  Tile_X9Y3_A_OUT_top, //EXTERNAL
        output  Tile_X9Y3_A_IN_top, //EXTERNAL
        output  Tile_X9Y3_A_EN_top, //EXTERNAL
        input  Tile_X9Y3_B_OUT_top, //EXTERNAL
        output  Tile_X9Y3_B_IN_top, //EXTERNAL
        output  Tile_X9Y3_B_EN_top, //EXTERNAL
        ...
        input  Tile_X9Y4_A_OUT_top, //EXTERNAL
        output  Tile_X9Y4_A_IN_top, //EXTERNAL
        output  Tile_X9Y4_A_EN_top, //EXTERNAL
        input  Tile_X9Y4_B_OUT_top, //EXTERNAL
        output  Tile_X9Y4_B_IN_top, //EXTERNAL
        output  Tile_X9Y4_B_EN_top, //EXTERNAL
        ...
        input  Tile_X9Y5_A_OUT_top, //EXTERNAL
        output  Tile_X9Y5_A_IN_top, //EXTERNAL
        output  Tile_X9Y5_A_EN_top, //EXTERNAL
        input  Tile_X9Y5_B_OUT_top, //EXTERNAL
        output  Tile_X9Y5_B_IN_top, //EXTERNAL
        output  Tile_X9Y5_B_EN_top, //EXTERNAL
        ...
        input  Tile_X9Y6_A_OUT_top, //EXTERNAL
        output  Tile_X9Y6_A_IN_top, //EXTERNAL
        output  Tile_X9Y6_A_EN_top, //EXTERNAL
        input  Tile_X9Y6_B_OUT_top, //EXTERNAL
        output  Tile_X9Y6_B_IN_top, //EXTERNAL
        output  Tile_X9Y6_B_EN_top, //EXTERNAL
...
wire[3:0] Tile_X6Y7_W_GBUF_FEED_BEG;
wire[3:0] Tile_X6Y7_N_GBUF_BEG;
wire[3:0] Tile_X6Y7_E_GBUF_BEG;
...
wire[3:0] Tile_X7Y7_W_GBUF_FEED_BEG;
wire[3:0] Tile_X7Y7_N_GBUF_BEG;
wire[3:0] Tile_X7Y7_E_GBUF_BEG;
...
wire[3:0] Tile_X8Y7_W_GBUF_FEED_BEG;
wire[3:0] Tile_X8Y7_N_GBUF_BEG;
wire[3:0] Tile_X8Y7_E_GBUF_BEG;
...
wire[3:0] Tile_X9Y7_W_GBUF_FEED_BEG;
...
`endif
    ...
    .Tile_X0Y1_N_GBUF_END(Tile_X6Y3_N_GBUF_BEG),
    ...
    .Tile_X0Y0_N_GBUF_BEG(Tile_X6Y1_N_GBUF_BEG),
...
`endif
    ...
    .Tile_X0Y1_N_GBUF_END(Tile_X6Y5_N_GBUF_BEG),
    ...
    .Tile_X0Y0_N_GBUF_BEG(Tile_X6Y3_N_GBUF_BEG),
...
`endif
    Tile_X9Y3_E_IO2
    (
    .N_GBUF_END(Tile_X9Y4_N_GBUF_BEG),
    ...
    .A_OUT_top(Tile_X9Y3_A_OUT_top),
    .A_IN_top(Tile_X9Y3_A_IN_top),
    .A_EN_top(Tile_X9Y3_A_EN_top),
    .B_OUT_top(Tile_X9Y3_B_OUT_top),
    .B_IN_top(Tile_X9Y3_B_IN_top),
    .B_EN_top(Tile_X9Y3_B_EN_top),
...
`endif
    Tile_X9Y4_E_IO2
    (
    .N_GBUF_END(Tile_X9Y5_N_GBUF_BEG),
    .E1END(Tile_X8Y4_E1BEG),
    .E2MID(Tile_X8Y4_E2BEG),
    .E2END(Tile_X8Y4_E2BEGb),
    .EE4END(Tile_X8Y4_EE4BEG),
    .E6END(Tile_X8Y4_E6BEG),
    .N_GBUF_BEG(Tile_X9Y4_N_GBUF_BEG),
    .W1BEG(Tile_X9Y4_W1BEG),
    .W2BEG(Tile_X9Y4_W2BEG),
    .W2BEGb(Tile_X9Y4_W2BEGb),
    .WW4BEG(Tile_X9Y4_WW4BEG),
    .W6BEG(Tile_X9Y4_W6BEG),
    .A_OUT_top(Tile_X9Y4_A_OUT_top),
    .A_IN_top(Tile_X9Y4_A_IN_top),
    .A_EN_top(Tile_X9Y4_A_EN_top),
    .B_OUT_top(Tile_X9Y4_B_OUT_top),
    .B_IN_top(Tile_X9Y4_B_IN_top),
    .B_EN_top(Tile_X9Y4_B_EN_top),
...
`endif
    ...
    .Tile_X0Y1_N_GBUF_END(Tile_X6Y7_N_GBUF_BEG),
    ...
    .Tile_X0Y0_N_GBUF_BEG(Tile_X6Y5_N_GBUF_BEG),
...
`endif
    Tile_X9Y5_E_IO2
    (
    .N_GBUF_END(Tile_X9Y6_N_GBUF_BEG),
    .E1END(Tile_X8Y5_E1BEG),
    .E2MID(Tile_X8Y5_E2BEG),
    .E2END(Tile_X8Y5_E2BEGb),
    .EE4END(Tile_X8Y5_EE4BEG),
    .E6END(Tile_X8Y5_E6BEG),
    .N_GBUF_BEG(Tile_X9Y5_N_GBUF_BEG),
    .W1BEG(Tile_X9Y5_W1BEG),
    .W2BEG(Tile_X9Y5_W2BEG),
    .W2BEGb(Tile_X9Y5_W2BEGb),
    .WW4BEG(Tile_X9Y5_WW4BEG),
    .W6BEG(Tile_X9Y5_W6BEG),
    .A_OUT_top(Tile_X9Y5_A_OUT_top),
    .A_IN_top(Tile_X9Y5_A_IN_top),
    .A_EN_top(Tile_X9Y5_A_EN_top),
    .B_OUT_top(Tile_X9Y5_B_OUT_top),
    .B_IN_top(Tile_X9Y5_B_IN_top),
    .B_EN_top(Tile_X9Y5_B_EN_top),
...
`endif
    Tile_X9Y6_E_IO2
    (
    .N_GBUF_END(Tile_X9Y7_N_GBUF_BEG),
    .E1END(Tile_X8Y6_E1BEG),
    .E2MID(Tile_X8Y6_E2BEG),
    .E2END(Tile_X8Y6_E2BEGb),
    .EE4END(Tile_X8Y6_EE4BEG),
    .E6END(Tile_X8Y6_E6BEG),
    .N_GBUF_BEG(Tile_X9Y6_N_GBUF_BEG),
    .W1BEG(Tile_X9Y6_W1BEG),
    .W2BEG(Tile_X9Y6_W2BEG),
    .W2BEGb(Tile_X9Y6_W2BEGb),
    .WW4BEG(Tile_X9Y6_WW4BEG),
    .W6BEG(Tile_X9Y6_W6BEG),
    .A_OUT_top(Tile_X9Y6_A_OUT_top),
    .A_IN_top(Tile_X9Y6_A_IN_top),
    .A_EN_top(Tile_X9Y6_A_EN_top),
    .B_OUT_top(Tile_X9Y6_B_OUT_top),
    .B_IN_top(Tile_X9Y6_B_IN_top),
    .B_EN_top(Tile_X9Y6_B_EN_top),
...
`endif
    ...
    .W_GBUF_FEED_END(Tile_X6Y7_W_GBUF_FEED_BEG),
    .W_GBUF_FEED_BEG(Tile_X5Y7_W_GBUF_FEED_BEG),
    .N_GBUF_BEG(Tile_X5Y7_N_GBUF_BEG),
    .E_GBUF_BEG(Tile_X5Y7_E_GBUF_BEG),
...
`endif
    Tile_X6Y7_S_term_MACC
    (
    .E_GBUF_END(Tile_X5Y7_E_GBUF_BEG),
    .S1END(Tile_X6Y6_S1BEG),
    .S2MID(Tile_X6Y6_S2BEG),
    .S2END(Tile_X6Y6_S2BEGb),
    .S4END(Tile_X6Y6_S4BEG),
    .SS4END(Tile_X6Y6_SS4BEG),
    .W_GBUF_FEED_END(Tile_X7Y7_W_GBUF_FEED_BEG),
    .W_GBUF_FEED_BEG(Tile_X6Y7_W_GBUF_FEED_BEG),
    .N_GBUF_BEG(Tile_X6Y7_N_GBUF_BEG),
    .E_GBUF_BEG(Tile_X6Y7_E_GBUF_BEG),
...
`endif
    Tile_X7Y7_S_term_single
    (
    .E_GBUF_END(Tile_X6Y7_E_GBUF_BEG),
    .S1END(Tile_X7Y6_S1BEG),
    .S2MID(Tile_X7Y6_S2BEG),
    .S2END(Tile_X7Y6_S2BEGb),
    .S4END(Tile_X7Y6_S4BEG),
    .SS4END(Tile_X7Y6_SS4BEG),
    .W_GBUF_FEED_END(Tile_X8Y7_W_GBUF_FEED_BEG),
    .W_GBUF_FEED_BEG(Tile_X7Y7_W_GBUF_FEED_BEG),
    .N_GBUF_BEG(Tile_X7Y7_N_GBUF_BEG),
    .E_GBUF_BEG(Tile_X7Y7_E_GBUF_BEG),
...
`endif
    Tile_X8Y7_S_term_single
    (
    .E_GBUF_END(Tile_X7Y7_E_GBUF_BEG),
    .S1END(Tile_X8Y6_S1BEG),
    .S2MID(Tile_X8Y6_S2BEG),
    .S2END(Tile_X8Y6_S2BEGb),
    .S4END(Tile_X8Y6_S4BEG),
    .SS4END(Tile_X8Y6_SS4BEG),
    .W_GBUF_FEED_END(Tile_X9Y7_W_GBUF_FEED_BEG),
    .W_GBUF_FEED_BEG(Tile_X8Y7_W_GBUF_FEED_BEG),
    .N_GBUF_BEG(Tile_X8Y7_N_GBUF_BEG),
    .E_GBUF_BEG(Tile_X8Y7_E_GBUF_BEG),
...
`endif
    Tile_X9Y7_SE_term
    (
    .E_GBUF_END(Tile_X8Y7_E_GBUF_BEG),
    .W_GBUF_FEED_BEG(Tile_X9Y7_W_GBUF_FEED_BEG),
    .N_GBUF_BEG(Tile_X9Y7_N_GBUF_BEG),
